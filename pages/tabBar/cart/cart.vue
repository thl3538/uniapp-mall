	...
	<view>
			...
			<view class="row" v-for="(item,index) in goodsList" :key="index">
				...
				:class="[theIndex == index ? 'open' : oldIndex == index ? 'close' : '']">
					...
					<view class="container">
						<view class="checkbox" @tap="handleCheckbox(item)">
							<view :class="{'on':item.selected == true}"></view>
						</view>
					</view>
					<!-- 商品详情 -->
						...
						<view class="info">
							...
							<view class="price-number">
								<view class="price-number">
									...
									<counter @sub="sub(item)" @add="add(item)" :goodsInfo="item" /> 
								</view>
							</view>
						</view>
					</view>
		...
		<view class="footer" :style="{bottom:footerBottom}">
			...
			<view class="settlement">
				...
				<view @tap="handleConfirm" class="btn">
