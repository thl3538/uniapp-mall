	...
	<view>
		...
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="left">
				<view @tap="handleCategory(index)" :class="{'on':showCategoryIndex == index}" class="row" v-for="(item,index) in categoryList" :key="index">
					<view class="text">
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category,index) in categoryList" :key="category.id" v-show="index == showCategoryIndex" >
					...
					<view class="list">
						<view @tap="handleCategoryList(item)" class="box" v-for="(item,i) in category.list" :key="i" v-show="index == showCategoryIndex">
